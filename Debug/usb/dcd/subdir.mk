...
C_SRCS += \
../usb/dcd/usb_phydcd.c 

C_DEPS += \
./usb/dcd/usb_phydcd.d 

OBJS += \
./usb/dcd/usb_phydcd.o 


# Each subdirectory must supply rules for building sources it contributes
usb/dcd/%.o: ../usb/dcd/%.c usb/dcd/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-usb-2f-dcd

clean-usb-2f-dcd:
	-$(RM) ./usb/dcd/usb_phydcd.d ./usb/dcd/usb_phydcd.o

.PHONY: clean-usb-2f-dcd
